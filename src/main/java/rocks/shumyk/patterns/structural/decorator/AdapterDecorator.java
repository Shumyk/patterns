...
class MyStringBuilder {
	...
	public MyStringBuilder(final String initialValue) {
		sb.append(initialValue);
	}

	public MyStringBuilder concat(final String string) {
		return new MyStringBuilder(sb.toString().concat(string));
	}

	public MyStringBuilder appendLine(final String str) {
...
public class AdapterDecorator {
	public static void main(String[] args) {
		final MyStringBuilder b = new MyStringBuilder();
		b.append("hello")
			.appendLine(" world");
		log.info("{}", b.concat("and this too"));
	}
}
